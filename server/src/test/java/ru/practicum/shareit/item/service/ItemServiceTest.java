...
public class ItemServiceTest {
    ...
    void getItemsByUserExceptionTest() {
        ...
        when(itemRepository.findAllByOwnerIdOrderByIdAsc(eq(1L), any())).thenReturn(null);
        assertThrows(ItemNotFoundException.class, () -> itemService.getItemsByUser(1L, 0, 20));

        when(itemRepository.findAllByOwnerIdOrderByIdAsc(eq(1L), any())).thenReturn(List.of(item));
