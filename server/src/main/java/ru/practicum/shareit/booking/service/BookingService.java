...
public interface BookingService {
    ...
    List<BookingDto> getBooking(long userId, String stateParam, int from, int size);

    List<BookingDto> getOwnerBooking(long userId, String stateParam, int from, int size);
}
